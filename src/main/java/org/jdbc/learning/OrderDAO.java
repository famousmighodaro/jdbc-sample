...
public class OrderDAO extends DataAccessObject<Order> {
    ...
    private  final  static  String GET_FOR_CUST = "call get_orders_by_customer(?)";
    ...
    public List<Order> getOrderForCustomer(long customer_id) {
       ...
       try (PreparedStatement statement = this.connection.prepareStatement(GET_FOR_CUST)) {
            ...
            while (rs.next()) {
               ...
               if (orderId != localOrderId) {
                   ...
                   order.setSalespersonLastName(rs.getString(2));
